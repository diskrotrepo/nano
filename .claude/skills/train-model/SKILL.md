...
description: >-
  ...
  pipeline-validation runs and Modal multi-GPU (B200:4) DDP full runs. Use this skill when the
...
| **LoRA (local or Modal 1×H100)** | `… --init-from <ckpt> --lora …` | Adapt a trained checkpoint on new data — the frozen base makes the ~2.0B trainable on a single GPU / Apple Silicon. See [README.finetune.md](../../../README.finetune.md). |
...
#    fall back to /v9_stereo/best.pt if you skipped the export
```
